...
def visualize_tensor_structure(tensor_path=None, audio_path=None):
    ...
    if tensor_path and os.path.exists(tensor_path):
        ...
        tensor = generate_mel_spectrogram_torch_tensor(audio_path, None, return_tensor=True)
    ...
    fig.suptitle('40ms Audio Tensor Visualization: [2, 64, 3] = [Stereo, Frequency, Time]', fontsize=16)
...
def print_tensor_values_sample(tensor, max_frames_to_show=3):
    ...
    print(f"Remember: This is NOT RGB! It's [stereo_channels, frequency_bins, time_frames]")
...
if __name__ == "__main__":
    ...
    sample_audio = "dataset/sample_0000.wav"
